...
public class RectangleTest {
    ...
    public void testValidConstruction() throws Exception {
        ...
        assertSame(center, myRectangle.getCenter());        
        ...
        assertEquals(1.3, myRectangle1.getCenter().getX(), 0);
        assertEquals(2.6, myRectangle1.getCenter().getY(), 0);
    ...
    public void testInvalidConstruction() {
        ...
        try {
            new Rectangle( new Point(1, 2), Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
            fail("Expected exception not thrown");
        } catch (Exception e) {
            // ignore
        }
        ...
        try {
            new Rectangle(new Point(1, 2), Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY);
            fail("Expected exception not thrown");
        } catch (Exception e) {
            // ignore
        }
        ...
        try {
            new Rectangle(new Point(1, 2), Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY);
            fail("Expected exception not thrown");
        } catch (Exception e) {
            // ignore
        }
        try {
            new Rectangle(new Point(1, 2), Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);
            fail("Expected exception not thrown");
        } catch (Exception e) {
            // ignore
        }
        ...
        try {
            new Rectangle(new Point(1, 2), Double.NaN, Double.NaN);
            fail("Expected exception not thrown");
        } catch (Exception e) {
            // ignore
        }
        ...
        public void testMove() throws ShapeException {
            ...
            assertEquals(4.123, myRectangle.getCenter().getX(), 0);
            assertEquals(6.456, myRectangle.getCenter().getY(), 0);
            assertEquals(5, myRectangle.getWidth(), 0);
            assertEquals(10, myRectangle.getHeight(), 0);
            ...
            assertEquals(-8, myRectangle.getCenter().getX(), 0);
            assertEquals(-20, myRectangle.getCenter().getY(), 0);
            assertEquals(5, myRectangle.getWidth(), 0);
            assertEquals(10, myRectangle.getHeight(), 0);
        ...
        public void testScale() throws ShapeException {
            ...
            myRectangle.scale(3);
            assertEquals(1, myRectangle.getCenter().getX(), 0);
            assertEquals(225, myRectangle.getCenter().getY(), 0);
